...
<body>
    ...
    <div class="container ajuste">
        ...
        <div class="details">
            <div class="content">
                <h2>Pizza Margherita<br>
                    <span>(Especial)</span>
                </h2>
                <p>
                A Pizza Margherita  é uma deliciosa combinação de massa fina, molho de tomate, queijo muçarela, 
            ...
            <form action="add_to_cart.php" method="post">
                    <input type="hidden" name="pizza_id" value="9"> <!-- Coloque aqui o ID correspondente a esta pizza -->
                ...
                <form action="personalizacao.php" method="post">
                    <div class="animacao">
                        <input type="hidden" name="pizza_perso" value="9">
