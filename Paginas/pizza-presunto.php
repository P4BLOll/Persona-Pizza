...
<body>
    ...
    <div class="container ajuste">
        <div class="imgBx" style="background-image: url('img/Fundo_Pizzaria.jpg');">
           <img src="img/Pizza de presunto, de cima.png" alt="">
        </div>
        <div class="details">
            <div class="content">
                ...
                <p>
                A pizza de presunto é uma verdadeira delícia. Com massa, molho de tomate, 
                presunto e queijo, ela é simples e saborosa, agradando a muitos paladares.
                </p>
                <div class="preco">
                    <h3>R$ 22,00</h3>
                </div>
            ...
            <form action="add_to_cart.php" method="post">
                ...
                <form action="personalizacao.php" method="post">
                    <div class="animacao">
                        <input type="hidden" name="pizza_perso" value="8">
